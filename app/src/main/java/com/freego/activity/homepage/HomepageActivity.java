package com.freego.activity.homepage;
...
public class HomepageActivity extends Activity {
    ...
    class DownloadTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        private void downloadFile() {
            ...
            try {
                HttpURLConnection connection = HttpUtil.getConnection_HttpFileUtil(pageAction);
        ...
        private Bitmap downloadIcon() {
            Bitmap bitmap = null;
            try {
                if (HttpUtil.getConnection_HttpFileUtil(icon).getResponseCode() == 200) {
                    InputStream inputStream = HttpUtil.getConnection_HttpFileUtil(icon).getInputStream();
                    bitmap = BitmapFactory.decodeStream(inputStream);
                    File file = new File("data/data/com.freego/files/profile/" + id + "/icon_" + fileName);
