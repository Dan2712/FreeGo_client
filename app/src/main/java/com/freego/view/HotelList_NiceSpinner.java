...
import com.freego.R;
import com.freego.adapter.HotelList_HotelList_NiceSpinnerAdapter;
import com.freego.adapter.HotelList_HotelList_NiceSpinnerAdapterWrapper;
import com.freego.adapter.HotelList_NiceSpinnerBaseAdapter;

import java.util.List;

public class HotelList_NiceSpinner extends TextView {
    ...
    private HotelList_NiceSpinnerBaseAdapter mAdapter;
    private AdapterView.OnItemClickListener mOnItemClickListener;
    private AdapterView.OnItemSelectedListener mOnItemSelectedListener;
    private boolean mHideArrow;

    @SuppressWarnings("ConstantConditions")
    public HotelList_NiceSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public HotelList_NiceSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HotelList_NiceSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public <T> void attachDataSource(@NonNull List<T> dataset) {
        mAdapter = new HotelList_HotelList_NiceSpinnerAdapter<>(getContext(), dataset);
        setAdapterInternal(mAdapter);
    }

    public void setAdapter(@NonNull ListAdapter adapter) {
        mAdapter = new HotelList_HotelList_NiceSpinnerAdapterWrapper(getContext(), adapter);
        setAdapterInternal(mAdapter);
    }

    private void setAdapterInternal(@NonNull HotelList_NiceSpinnerBaseAdapter adapter) {
