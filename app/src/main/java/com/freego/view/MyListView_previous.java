 ...
 */
public class MyListView_previous extends ListView implements AbsListView.OnScrollListener {
    ...
    public MyListView_previous(Context context) {
        super(context);
        initWithContext(context);
    }

    public MyListView_previous(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWithContext(context);
    }

    public MyListView_previous(Context context, AttributeSet attrs, int defStyle) {
